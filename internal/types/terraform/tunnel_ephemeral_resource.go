...
type HypervisorEphemeralTunnelResourceDataModel struct {
...
type GuestEphemeralTunnelResourceDataModel struct {
	...
	KnownHosts           types.List   `tfsdk:"known_hosts"`
	KnownHostsFile       types.String `tfsdk:"known_hosts_file"`
	IgnoreHostKey        types.Bool   `tfsdk:"ssh_ignore_host_key"`
	UseSSHFP             types.Bool   `tfsdk:"use_sshfp"`
	DNSRecursiveServer   types.String `tfsdk:"dns_resolver"`
	CAFile               types.String `tfsdk:"ca_file"`
}

type EphemeralTunnelResourceDataModel struct {
	Hypervisor *HypervisorEphemeralTunnelResourceDataModel `tfsdk:"hypervisor"`
	Guest      GuestEphemeralTunnelResourceDataModel       `tfsdk:"guest"`
